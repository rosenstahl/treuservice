...
export default function EntkernungsGuidePage() {
  ...
  const author = {
    ...
    image: "/images/team/entkernung-expert.jpg"
  };
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg border border-accent/10 shadow-sm">
                      ...
                      <div className="space-y-4 mt-4">
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">1. Behördliche Vorbereitungen</div>
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">2. Technische Vorbereitungen</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                        ...
                        {/* Dokumentation */}
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">3. Dokumentation & Planung</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                        ...
                        {/* Versicherung & Schutz */}
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">4. Versicherung & Schutz</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <Link 
                        ...
                        className="block hover:bg-accent/5 p-2 rounded transition-colors text-sm"
                      >
                        Nachhaltige Reinigung nach Entkernungen
                      </Link>
                      <Link 
                        href="/entkernung" 
                        className="block hover:bg-accent/5 p-2 rounded transition-colors text-sm"
