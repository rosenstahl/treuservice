...
export default function EntruempelungsGuidePage() {
  ...
  const author = {
    ...
    image: "/images/team/entruempelung-expert.jpg"
  };
              ...
              <Tabs defaultValue="prozess" className="w-full mb-8">
                ...
                <TabsContent value="materialien">
                  <div className="space-y-6">
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <Card className="bg-red-50 border-red-100 shadow-none">
                            <CardHeader className="px-4 py-3 pb-1">
                              <CardTitle className="text-base text-red-700">Gefahrstoffe und Problemabfälle</CardTitle>
                            </CardHeader>
                            <CardContent className="px-4 pt-0 pb-4">
                    ...
                    {/* Grafik: Materialmengenschätzung */}
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">Typische Materialverteilung bei einer Entrümpelung</CardTitle>
                        <CardDescription>Durchschnittliche Zusammensetzung bei einer Standardentrümpelung</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="relative h-56 w-full">
                          <Image
                            src="/images/blog/entruempelung-materialverteilung.jpg"
                            alt="Diagramm: Materialverteilung bei einer durchschnittlichen Entrümpelung"
                            fill
                        ...
                        <ul className="text-sm space-y-1 mt-4">
                          <li className="flex gap-2">
                            ...
                            <span>Sperrmüll: 45-55%</span>
                          </li>
                          <li className="flex gap-2">
                            <div className="w-3 h-3 bg-green-500 rounded-full mt-1.5"></div>
                            <span>Wertstoffe: 20-30%</span>
                          </li>
                          <li className="flex gap-2">
                            <div className="w-3 h-3 bg-yellow-500 rounded-full mt-1.5"></div>
                            <span>Elektronikschrott: 10-15%</span>
                          </li>
                          <li className="flex gap-2">
                            <div className="w-3 h-3 bg-red-500 rounded-full mt-1.5"></div>
                            <span>Gefahrstoffe: 2-5%</span>
                          </li>
                          <li className="flex gap-2">
                            <div className="w-3 h-3 bg-purple-500 rounded-full mt-1.5"></div>
                            <span>Wertgegenstände: 5-15%</span>
                          </li>
                        </ul>
                      </CardContent>
                    </Card>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg border border-accent/10 shadow-sm">
                      <div className="flex items-start gap-3">
                        <ClipboardList className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                        <div>
                      ...
                      <div className="space-y-4 mt-4">
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">1. Vor der Entrümpelung</div>
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">2. Planung der Entrümpelung</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">3. Während der Entrümpelung</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                        ...
                        <div>
                          <div className="font-medium text-sm text-accent mb-1">4. Nach der Entrümpelung</div>
                          <ul className="text-sm space-y-1">
                            <li className="flex items-start gap-2">
                              <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                    ...
                    <Card className="bg-blue-50 border-blue-200">
                      ...
                      <CardContent>
                        <p className="mb-4 text-sm">
                          Unsere ausführliche Entrümpelungs-Checkliste können Sie hier als PDF herunterladen und ausdrucken:
                        </p>
                        <Link href="/downloads/entruempelungs-checkliste.pdf">
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          <div className="relative h-64 w-full">
                            <Image
                              src="/images/blog/entruempelung-saisonkalender.jpg"
                              alt="Saisonkalender für Entrümpelungen"
                              fill
                              className="object-contain"
                            />
                          </div>
                ...
                <Card className="bg-blue-50 border-blue-200">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg flex items-center gap-2">
                      ...
                      Entrümpelung benötigt?
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Paragraph className="text-sm mb-4">
                      Unser Team steht Ihnen für eine professionelle und diskrete Entrümpelung zur Verfügung. Kontaktieren Sie uns für eine kostenlose Erstberatung.
                    </Paragraph>
                    <Link href="/entruempelung#kontakt">
