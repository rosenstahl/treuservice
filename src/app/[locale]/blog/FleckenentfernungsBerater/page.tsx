...
const loesungen = {
  ...
  "kaffee-polster": {
    einfach: "Mit kaltem Wasser und etwas Flüssigwaschmittel abtupfen, nicht reiben!",
    fortgeschritten: "Lösung aus 2 Teilen Wasser, 1 Teil weißem Essig und einem Spritzer Spülmittel auftragen. Mit einem Mikrofasertuch vorsichtig abtupfen.",
  ...
  "default": {
    ...
    profi: "Für diese spezifische Kombination empfehlen wir eine professionelle Reinigung. Unsere Experten verfügen über spezielle Mittel und Geräte für optimale Ergebnisse.",
    hinweis: "Testen Sie jedes Reinigungsmittel zuerst an einer unauffälligen Stelle, um Verfärbungen zu vermeiden."
  }
};
