...
export default function LeiharbeitGuidePage() {
  ...
  const author = {
    ...
    image: "/images/team/leiharbeit-expert.jpg"
  };
                ...
                <TabsContent value="grundlagen">
                  <div className="space-y-6">
                    ...
                    <div className="bg-white p-4 rounded-lg border border-blue-500/10 shadow-sm">
                      ...
                      <div className="relative bg-blue-50 p-4 rounded-lg mb-6">
                        <div className="text-center mb-6">
                                                      <div className="font-medium text-blue-700">Das Dreiecksverhältnis der Leiharbeit</div>
                        </div>
                        <div className="grid grid-cols-3 gap-4 relative">
                          <div className="text-center">
                            <div className="mx-auto w-16 h-16 rounded-full flex items-center justify-center bg-blue-100 border border-blue-200 mb-2">
                        ...
                        <div className="space-y-4 text-sm">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-white p-3 rounded-lg shadow-sm">
                              <div className="font-medium mb-2 text-blue-600">Digitalisierung der Personalbeschaffung</div>
                              <p className="text-muted-foreground">
                            ...
                            <div className="bg-white p-3 rounded-lg shadow-sm">
                              <div className="font-medium mb-2 text-blue-600">Zunehmende Spezialisierung</div>
                              <p className="text-muted-foreground">
                            ...
                            <div className="bg-white p-3 rounded-lg shadow-sm">
                              <div className="font-medium mb-2 text-blue-600">Hybride Arbeitsmodelle</div>
                              <p className="text-muted-foreground">
                            ...
                            <div className="bg-white p-3 rounded-lg shadow-sm">
                              <div className="font-medium mb-2 text-blue-600">Strategische Personalpartnerschaften</div>
                              <p className="text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <Link 
                        href="/blog" 
                        className="block hover:bg-pink-600/5 p-2 rounded transition-colors text-sm"
                      >
                      ...
                      <Link 
                        ...
                        className="block hover:bg-pink-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Unsere Leiharbeits-Dienstleistungen im Detail
                      </Link>
                      <Link 
                        href="/blog" 
                        className="block hover:bg-pink-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Arbeitsrecht aktuell: Wichtige Änderungen 2025
                      </Link>
                    </div>
                  </CardContent>
                </Card>
