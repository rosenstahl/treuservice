...
export default function PVGuidePage() {
  ...
  const author = {
    ...
    image: "/images/team/pv-experte.jpg"
  };
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <Link 
                        href="/blog/photovoltaik-reinigung" 
                        className="block hover:bg-yellow-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Reinigung und Wartung von PV-Anlagen
                      </Link>
                      <Link 
                        href="/blog/pv-ertragsmessung" 
                        className="block hover:bg-yellow-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Ertragsmessung und Optimierung
                      </Link>
                      <Link 
                        href="/pv-montage" 
                        className="block hover:bg-yellow-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Unsere PV-Montage-Dienstleistungen im Detail
                      </Link>
                      <Link 
                        href="/blog/pv-speicher-guide" 
                        className="block hover:bg-yellow-600/5 p-2 rounded transition-colors text-sm"
                      >
                        Photovoltaik-Speicher: Der ultimative Guide
                      </Link>
                    </div>
                  </CardContent>
                </Card>
