              ...
              <div className="prose max-w-none">
                <div className="relative rounded-2xl overflow-hidden mb-8">
                  <div className="w-full aspect-video">
                    <Image 
                      src="/images/blog/raeumpflicht-header.jpg" 
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-1 text-sm">
                      <li>
                        <a href="#grundlagen" className="flex items-center text-muted-foreground hover:text-primary transition-colors">
                          <ArrowRight className="h-3 w-3 mr-2" />
                          Die Grundlagen der Räumpflicht
                        </a>
                      </li>
                      <li>
                        <a href="#interaktiv" className="flex items-center text-muted-foreground hover:text-primary transition-colors">
                          <ArrowRight className="h-3 w-3 mr-2" />
                          Interaktiver Räumpflicht-Assistent
                        </a>
                      </li>
                      <li>
                        <a href="#regional" className="flex items-center text-muted-foreground hover:text-primary transition-colors">
                          <ArrowRight className="h-3 w-3 mr-2" />
                      ...
                      <li>
                        <a href="#faq" className="flex items-center text-muted-foreground hover:text-primary transition-colors">
                          <ArrowRight className="h-3 w-3 mr-2" />
                          Häufig gestellte Fragen
                        </a>
                      </li>
                      <li>
                        <a href="#checkliste" className="flex items-center text-muted-foreground hover:text-primary transition-colors">
                          <ArrowRight className="h-3 w-3 mr-2" />
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      >
                        DIY vs. Professioneller Winterdienst: Kostenvergleich
                      </Link>
                      <Link 
                        href="/blog/StreumittelRechnerundVergleich" 
                        className="block hover:bg-accent/5 p-2 rounded transition-colors text-sm"
                      >
                        Streumittel-Vergleich: Umweltschutz & Wirksamkeit
                      </Link>
                      <Link 
                        href="/blog/StreumittelRechnerundVergleich" 
                        className="block hover:bg-accent/5 p-2 rounded transition-colors text-sm"
                      ...
                      <Link 
                        ...
                        className="block hover:bg-accent/5 p-2 rounded transition-colors text-sm"
                      >
                        Unsere Winterdienst-Angebote im Detail
                      </Link>
                    </div>
                  </CardContent>
                </Card>
