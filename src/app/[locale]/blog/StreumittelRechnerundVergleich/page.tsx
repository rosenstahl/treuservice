          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-8 space-y-6">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Weitere Winterdienst-Artikel</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                      <Link 
                        href="/blog/RaeumpflichtGuide2025" 
                        className="block hover:bg-gray-100 p-2 rounded transition-colors text-sm"
                      >
                      ...
                      <Link 
                        ...
                        className="block hover:bg-gray-100 p-2 rounded transition-colors text-sm"
                      >
                        Kostenrechner: DIY vs. Profi-Winterdienst
                      </Link>
                      <Link 
                        href="/winterdienst" 
                        className="block hover:bg-gray-100 p-2 rounded transition-colors text-sm"
                      >
                        Professionelle Winterdienst-Angebote
                      </Link>
                    </div>
                  </CardContent>
                </Card>
