...
const CostCalculator = () => {
  ...
  const [snowDepth, setSnowDepth] = useState<"leicht" | "mittel" | "stark">("mittel");  const [frequency, setFrequency] = useState(20);
  const [showResults, setShowResults] = useState(false);
  
  // Preisintervalle und Staffelpreise laut Dokumentation
  const priceIntervals = [
    ...
    { min: 10001, max: 100000, price: 0.80 } // Für Flächen über 10.000m²
  ];
  
  // Berechnete Kosten
  const calculateDIYCosts = () => {
    ...
    const timeRequired = costPerUse.zeitaufwand[snowDepth]; // Stunden pro Einsatz
  ...
  const diyResults = calculateDIYCosts();
  const professionalResults = calculateProfessionalCosts();
  
  // Differenz berechnen (positive Zahl = DIY spart Geld)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-8 space-y-6">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg">Unsere Winterdienst-Serie</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      >
                        Räumpflicht-Guide 2025: Aktuelle Rechtslage
                      </Link>
                      <Link 
                        href="/blog/StreumittelRechnerundVergleich" 
                        className="block hover:bg-blue-50 p-2 rounded transition-colors text-sm"
                      >
                        Streumittel-Vergleich mit interaktivem Rechner
                      </Link>
                      <Link 
                        href="/winterdienst" 
                        className="block hover:bg-blue-50 p-2 rounded transition-colors text-sm"
