          ...
          <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200 max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-2/3">
                <h3 className="text-xl font-semibold mb-4 text-[#222425]">Entkernungs-Guide: Professioneller Prozess & Entscheidungshilfen</h3>
            ...
            {/* Neue Buttons für den erweiterten Guide */}
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/blog/EntkernungsGuide" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full border-blue-500 text-blue-500 hover:bg-blue-50 flex items-center gap-2">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 bg-green-50 rounded-lg p-6 border border-green-200">
              <div className="flex items-start gap-3 mb-4">
                <div className="p-2 rounded-full bg-white text-green-600 flex-shrink-0 shadow-sm">
                  <Banknote className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-green-800">Finanzierungs- und Fördermöglichkeiten</h3>
                  <p className="text-sm text-green-700 mt-1">
                    Für Entkernungs- und Sanierungsprojekte stehen verschiedene staatliche Fördermittel zur Verfügung.
                  </p>
                </div>
              </div>
              <p className="text-sm text-green-700 mb-4">
                Das Bundesamt für Wirtschaft und Ausfuhrkontrolle (BAFA) und die KfW bieten Zuschüsse und zinsgünstige Darlehen für energetische Sanierungen an.
              </p>
              <Link href="/blog/EntkernungsGuide?tab=finanzierung">
