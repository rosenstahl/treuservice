...
const ServiceCard = ({ title, description, benefits, details, case_study, icon }: ServiceCardProps) => {
  ...
  return (
    <div
      className={`bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-accent/5 h-full
        ${isExpanded ? '' : 'hover:border-accent/20'}`}
...
const ChallengeCard = ({ problem, issue, solution }: ChallengeCardProps) => (
  <div className="bg-white p-6 rounded-xl shadow-md border border-accent/5 h-full flex flex-col">
...
export default function LeiharbeitPage() {
  ...
  const serviceIcons = [
    ...
    <Tool key="tool" className="w-5 h-5" />
  ];
  ...
  return (
    <div className="flex-1">
      {/* HERO Section */}
      <Section className="relative bg-white pt-28 min-h-screen flex items-center">
        <Container>
            ...
            >
              <div>
                ...
                <button 
                  ...
                  className="mt-8 bg-accent hover:bg-accent/90 text-white px-8 py-3 rounded-lg font-medium transition-all hover:scale-105 flex items-center gap-2"
                >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {leiharbeitData.advantages.items.map((item, i) => (
                ...
                >
                  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg border border-accent/5 hover:border-accent/20 transition-all h-full flex flex-col">
      ...
      <Section id="kontakt" className="bg-white min-h-screen flex items-center">
        <Container>
          <div className="text-center mb-12">
            ...
            <Paragraph className="text-foreground/80 max-w-2xl mx-auto">
