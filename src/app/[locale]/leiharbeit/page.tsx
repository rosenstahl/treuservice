      ...
      <Section className="bg-white min-h-screen flex items-center py-0">
        <Container>
          <div className="text-center mb-12">
            ...
            <H2 className="mb-4 text-secondary">Leiharbeits-Guide: Vorteile, Planung & rechtskonforme Nutzung</H2>
            <Paragraph className="text-gray-600 max-w-2xl mx-auto">
              Unser umfassender Leiharbeits-Guide bietet Ihnen praktische Informationen und Best Practices für die erfolgreiche Integration von Leiharbeitern in Ihrem Unternehmen.
            </Paragraph>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200 max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="w-full md:w-1/3 flex justify-center">
                <div className="relative w-32 h-32 bg-blue-50 rounded-full flex items-center justify-center">
                  <Users className="w-16 h-16 text-pink-600" />
                </div>
              </div>
              
              <div className="w-full md:w-2/3">
                <h3 className="text-xl font-semibold mb-4 text-[#222425]">Leiharbeits-Guide: Rechtliches, Best Practices & Integration</h3>
                <Paragraph className="mb-6">
                  Leiharbeit bietet Unternehmen wertvolle Flexibilität, erfordert aber auch besondere Aufmerksamkeit bei rechtlichen und organisatorischen Aspekten. Unser Guide behandelt alle wichtigen Themen vom Arbeitnehmerüberlassungsgesetz bis hin zu bewährten Methoden für die erfolgreiche Integration von Leiharbeitern.
                </Paragraph>
                
                <Link href="/blog/LeiharbeitGuide?tab=rechtliches" className="inline-flex items-center group">
                  <span className="mr-2 inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-50 group-hover:bg-blue-100 transition-colors">
                    <FileText className="w-5 h-5 text-blue-600" />
                  </span>
                  <span className="text-blue-600 font-medium group-hover:underline">
                    Rechtliche Grundlagen und praktische Tipps
                  </span>
                  <ChevronRight className="ml-2 w-4 h-4 text-blue-600 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-blue-50 rounded-lg p-4 h-full flex flex-col">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base font-medium">Rechtliche Grundlagen</h3>
                  </div>
                  <p className="text-xs text-gray-600 flex-grow">
                    Detaillierte Erklärung des Arbeitnehmerüberlassungsgesetzes, Equal Pay und Treatment sowie aktuelle Gesetzesänderungen.
                  </p>
                </div>
                
                <div className="bg-pink-50 rounded-lg p-4 h-full flex flex-col">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm">
                      <Users className="w-4 h-4 text-pink-600" />
                    </div>
                    <h3 className="text-base font-medium">Integration & Prozess</h3>
                  </div>
                  <p className="text-xs text-gray-600 flex-grow">
                    Praxisnahe Anleitung für die erfolgreiche Integration von Leiharbeitern und einen optimalen Prozessablauf.
                  </p>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-4 h-full flex flex-col">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base font-medium">Vorteile & Best Practices</h3>
                  </div>
                  <p className="text-xs text-gray-600 flex-grow">
                    Strategien zur Maximierung der Vorteile von Leiharbeit und bewährte Methoden für die Zusammenarbeit mit Zeitarbeitsfirmen.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/leiharbeit#kontakt" className="w-full sm:w-auto">
