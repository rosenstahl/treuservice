  ...
  <Container>
    ...
    >
      <div className="text-center mb-10">
        ...
        <H2 className="mb-4 text-secondary">PV-Montage Ratgeber</H2>
        <Paragraph className="text-gray-600 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-md p-8 border border-gray-200 max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-2/3">
            <h3 className="text-xl font-semibold mb-4 text-secondary">Photovoltaik-Montage Guide: Optimale Planung, Installation & Ertragsmaximierung</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#FEF2F2] rounded-lg p-4 h-full flex flex-col">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium">Montagearten im Vergleich</h3>
              </div>
              <p className="text-xs text-gray-600 flex-grow">
                Detaillierte Vor- und Nachteile verschiedener Montagelösungen: Aufdach, Indach, Flachdach und Fassade - mit konkreten Kosten und ROI-Vergleichen.
              </p>
            </div>
            ...
            <div className="bg-[#F0F9FF] rounded-lg p-4 h-full flex flex-col">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium">Installation & Optimierung</h3>
              </div>
              <p className="text-xs text-gray-600 flex-grow">
                Expertentipps zu Installation, Qualitätssicherung und Ertragsoptimierung für bis zu 30% höhere Leistung Ihrer PV-Anlage.
              </p>
            </div>
            ...
            <div className="bg-[#ECFDF5] rounded-lg p-4 h-full flex flex-col">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-medium">DIY vs. Profi-Montage</h3>
              </div>
              <p className="text-xs text-gray-600 flex-grow">
                Eine praxisnahe Entscheidungshilfe zu den Vor- und Nachteilen von Selbstmontage versus professioneller Installation mit Kosten-Nutzen-Analyse.
              </p>
            </div>
          </div>
        </div>

        {/* Button für den Guide */}
        <div className="mt-8 flex justify-center">
          <Link href="/blog/PVGuide" className="w-full sm:w-auto">
            <Button className="w-full bg-accent hover:bg-gray-100 flex items-center gap-2">
