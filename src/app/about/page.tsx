...
// Typ-Definition für die i18n-Daten
...
// Typ-Definition für die Übersetzungen
...
export default function AboutPage() {
  // Feste Sprache statt aus URL
  const locale = "de" as keyof Translations
  const translations: Translations = { de: deData as LocaleData, en: enData as LocaleData }
    ...
    <main className="flex-1 font-sans">
      ...
      <Section className="bg-[#f5f5f7] py-20">
        <Container>
          ...
          {translations[locale]?.testimonials?.all && (
            <AnimatedTestimonials 
              testimonials={translations[locale].testimonials.all.map((t, index) => ({
                quote: t.quote,
                name: t.author,
      ...
      {/* Location Section with iframe - Apple Style */}
