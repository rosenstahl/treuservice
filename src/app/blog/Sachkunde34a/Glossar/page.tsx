...
export default function GlossarPage() {
  // Aktive Tab-State lokal verwalten
  const [activeTab, setActiveTab] = useState("glossar");
  const [activeGesetzTab, setActiveGesetzTab] = useState("gewo");
      ...
      <div className="space-y-8">
        <TabsList className="grid w-full grid-cols-1 md:grid-cols-2">
          <TabsTrigger 
            ...
            className={activeTab === "glossar" ? "bg-white text-slate-950 shadow-sm" : ""}
          >
            Fachbegriffe & Definitionen
          </TabsTrigger>
          <TabsTrigger 
            value="gesetze" 
            onClick={() => setActiveTab("gesetze")}
            className={activeTab === "gesetze" ? "bg-white text-slate-950 shadow-sm" : ""}
          >
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6">
                <TabsList className="grid grid-cols-2 md:grid-cols-4 w-full">
                  <TabsTrigger 
                    value="gewo" 
                    onClick={() => setActiveGesetzTab("gewo")}
                    className={activeGesetzTab === "gewo" ? "bg-white text-slate-950 shadow-sm" : ""}
                  >
                    GewO/BewachV
                  </TabsTrigger>
                  <TabsTrigger 
                    value="stgb" 
                    onClick={() => setActiveGesetzTab("stgb")}
                    className={activeGesetzTab === "stgb" ? "bg-white text-slate-950 shadow-sm" : ""}
                  >
                    StGB/StPO
                  </TabsTrigger>
                  <TabsTrigger 
                    value="bgb" 
                    onClick={() => setActiveGesetzTab("bgb")}
                    className={activeGesetzTab === "bgb" ? "bg-white text-slate-950 shadow-sm" : ""}
                  >
                    BGB
                  </TabsTrigger>
                  <TabsTrigger 
                    value="dsgvo" 
                    onClick={() => setActiveGesetzTab("dsgvo")}
                    className={activeGesetzTab === "dsgvo" ? "bg-white text-slate-950 shadow-sm" : ""}
                  >
                    DSGVO/BDSG
                  </TabsTrigger>
                </TabsList>
