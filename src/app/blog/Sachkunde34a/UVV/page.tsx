...
import { ArrowLeft, BookOpen, AlertTriangle, CheckCircle, HelpCircle, MousePointer, ExternalLink, FileText, Shield, AlertCircle, HardHat, First, FolderAlert } from "lucide-react";
            ...
            <div className="mt-6 space-y-6">
              <div className="border rounded-lg p-4">
                <h3 className="font-semibold text-lg mb-2 flex items-center">
                  <FolderAlert className="h-5 w-5 mr-2 text-blue-600" />
