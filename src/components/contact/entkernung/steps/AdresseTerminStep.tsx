        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-2">
                  ...
                  <Input
                    ...
                    className={`w-full bg-white ${errors.strasse ? 'border-red-300' : ''}`}
                    required
                  />
                  {errors.strasse && (
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleAdresseChange}
                    className={`w-full bg-white ${errors.hausnummer ? 'border-red-300' : ''}`}
                    required
                  />
                  {errors.hausnummer && (
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    value={adresse.plz}
                    onChange={handleAdresseChange}
                    className={`w-full bg-white ${errors.plz ? 'border-red-300' : ''}`}
                    required
                  />
                  {errors.plz && (
                ...
                <div className="col-span-2">
                  ...
                  <Input
                    ...
                    value={adresse.ort}
                    onChange={handleAdresseChange}
                    className={`w-full bg-white ${errors.ort ? 'border-red-300' : ''}`}
                    required
                  />
                  {errors.ort && (
          ...
          >
            ...
            <div className="space-y-4">
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        !wunschtermin && "text-muted-foreground",
              ...
              <div>
                <Label htmlFor="alternativtermin" className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      id="alternativtermin"
                      variant={"outline"}
                      className="w-full justify-start text-left font-normal bg-white border-gray-200 hover:bg-gray-100 hover:border-gray-300"
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
