        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              >
                <h3 className="text-lg font-medium text-gray-800 mb-3">Angaben zum Objekt</h3>
                
                <div className="space-y-2">
                  <div>
                    <p className="text-sm text-gray-500">Objekttyp:</p>
                    <p className="text-sm font-medium text-accent">{getObjektTypName()}</p>
                  </div>
                  ...
                  {formData.objektDetails.besonderheiten && (
                    <div>
                      ...
                      <p className="text-sm">{formData.objektDetails.besonderheiten}</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              >
                <h3 className="text-lg font-medium text-gray-800 mb-3">Entkernung & Umfang</h3>
                
                <div className="space-y-2">
                  <div>
                    <p className="text-sm text-gray-500">Art:</p>
                    <p className="text-sm font-medium">{formData.umfang.komplettEntkernung ? 'Komplettentkernung' : 'Selektiver Rückbau'}</p>
                  </div>
                  
                  {formData.umfang.selektiverRueckbau && formData.umfang.ausgewaehlteElemente.length > 0 && (
                    <div>
                      <p className="text-sm text-gray-500">Ausgewählte Elemente:</p>
                      <p className="text-sm font-medium">{formData.umfang.ausgewaehlteElemente.join(', ')}</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              >
                <h3 className="text-lg font-medium text-gray-800 mb-3">Schadstoffe & Optionen</h3>
                
                <div className="space-y-2">
                  <div>
                    <p className="text-sm text-gray-500">Schadstoffe:</p>
                    <p className="text-sm font-medium">{getSelectedSchadstoffeList()}</p>
                  </div>
                  
                  <div>
                    <p className="text-sm text-gray-500">Zusatzoptionen:</p>
                    <p className="text-sm font-medium">{getSelectedOptionslist()}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{formatDate(formData.adresseTermin.wunschtermin)}</p>
                  </div>
                  
                  {formData.adresseTermin.alternativtermin && (
                    <div>
                      <p className="text-sm text-gray-500">Alternativtermin:</p>
                      <p className="text-sm font-medium">{formatDate(formData.adresseTermin.alternativtermin)}</p>
                    </div>
                  )}
                </div>
              </motion.div>
        ...
        >
          ...
          <div className="bg-accent/10 rounded-lg p-6 mb-8 max-w-xl mx-auto">
            <div className="flex items-center justify-center mb-3">
              <HardHat className="h-5 w-5 mr-2 text-accent" />
              <h3 className="text-lg font-medium text-accent">Über unser Entkernungsteam</h3>
            </div>
