...
import { Clock, CreditCard, HomeIcon, Briefcase, Info } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {isUnternehmen && (
          <motion.div
            className="mb-8 border border-accent/30 rounded-lg p-4 bg-accent/5"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex items-center cursor-pointer" onClick={handleUeberstundenBereitschaftToggle}>
            <div className="flex items-center h-5">
              <input
                ...
                className="h-5 w-5 text-accent border-gray-300 rounded cursor-pointer"
              />
            </div>
            <div className="ml-3">
              <label htmlFor="ueberstundenBereitschaft" className="font-medium text-gray-700 cursor-pointer">
            ...
            <div>
              <div className="flex items-center cursor-pointer" 
                ...
                <input
                  ...
                  className="h-5 w-5 text-accent border-gray-300 rounded cursor-pointer"
                />
                <label htmlFor={isUnternehmen ? "unterkunftVorhanden" : "unterkunftBedarf"} 
