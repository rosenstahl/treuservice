...
import { CheckCircle, PhoneCall, Loader2, ArrowUpRight, Sparkle, MapPin, User, Mail, Phone, Building2, PenLine } from 'lucide-react';
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              >
                <h3 className="text-lg font-medium text-gray-800 mb-3">Ausgewählte Reinigungsleistung</h3>
                
                <div className="space-y-2">
                  <div>
                    <p className="text-sm text-gray-500">Reinigungsart:</p>
                    <p className="text-sm font-medium text-accent">{getReinigungsartDisplay()}</p>
                  </div>
                  ...
                  {formData.objektTyp.sonstigesText && (
                    <div>
                      ...
                      <p className="text-sm">{formData.objektTyp.sonstigesText}</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              >
                <h3 className="text-lg font-medium text-gray-800 mb-3">Flächeninformationen</h3>
                
                <div className="space-y-2">
                  <div>
                    <p className="text-sm text-gray-500">Zu reinigende Fläche:</p>
                    <p className="text-sm font-medium">{formData.flaecheInfo.flaeche} m²</p>
                  </div>
                  
                  <div>
                    <p className="text-sm text-gray-500">Anzahl Reinigungskräfte:</p>
                    <p className="text-sm font-medium">{formData.flaecheInfo.reinigungskraefte || 1} Personen</p>
                  </div>
                  
                  {formData.flaecheInfo.raumanzahl && (
                    <div>
                      <p className="text-sm text-gray-500">Raumanzahl:</p>
                  ...
                  {formData.flaecheInfo.etagenanzahl && (
                    <div>
                      ...
                      <p className="text-sm font-medium">{formData.flaecheInfo.etagenanzahl}</p>
                    </div>
                  )}
                  
                  {formData.flaecheInfo.fensteranzahl && (
                    <div>
                      <p className="text-sm text-gray-500">Fensteranzahl:</p>
                      <p className="text-sm font-medium">{formData.flaecheInfo.fensteranzahl}</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-sm font-medium">{getServiceTypDisplay()}</p>
                  </div>
                  ...
                  <div>
                    <p className="text-sm text-gray-500">{showDateRange() ? 'Einsatzzeitraum:' : 'Wunschtermin:'}</p>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{getDienstzeitenDisplay()}</p>
                  </div>
                </div>
              </motion.div>
        ...
        >
          ...
          <div className="bg-accent/10 rounded-lg p-6 mb-8 max-w-xl mx-auto">
            <div className="flex items-center justify-center mb-3">
              ...
              <h3 className="text-lg font-medium text-accent">Über unser Reinigungsteam</h3>
            </div>
