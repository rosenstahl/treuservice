      ...
      {!isSubmitted ? (
        <>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h3 className="text-lg font-medium text-accent mb-4">Kostenvoranschlag</h3>
              ...
              <div className="mt-4 text-xs text-gray-500">
                <p>Dies ist ein unverbindlicher Richtwert. Der finale Preis kann je nach individuellen Anforderungen und nach einer Besichtigung variieren.</p>
              </div>
            </motion.div>
