...
import { Flame, Droplet, Calendar, Info, Bug, AlertTriangle } from 'lucide-react'
...
export const SchadensdetailsStep: React.FC<SchadensdetailsStepProps> = ({
      ...
      <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
          {brandMaterialien.map((material) => (
            <div key={material.id} className="flex items-start space-x-2 p-3 bg-white rounded-lg border border-gray-100 hover:border-gray-200 transition-colors">
              <Checkbox2
              ...
              <div className="flex-1">
                <Label htmlFor={`material-${material.id}`} className="flex items-center text-sm font-medium text-gray-700">
                  {material.label}
                </Label>
              </div>
            </div>
  ...
  const renderWasserDetails = () => (
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        <RadioGroup
          value={formData.details.wasserUrsache}
          onValueChange={(value) => handleWasserUrsache(value as FormData['details']['wasserUrsache'])}
          className="space-y-3"
        >
          {[
            ...
            <div key={option.id} className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
              <RadioGroupItem 
                value={option.id} 
                id={`wasser-${option.id}`} 
                className="text-accent border-gray-300 focus:ring-accent"
              />
              <Label htmlFor={`wasser-${option.id}`} className="cursor-pointer text-sm font-medium text-gray-700 flex-1">
                {option.label}
              </Label>
            </div>
          ))}
      ...
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        >
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="sauber" id="wasser-sauber" className="text-accent border-gray-300 focus:ring-accent" />
            <div className="flex-1">
              <Label htmlFor="wasser-sauber" className="flex flex-col cursor-pointer">
                <span className="font-medium">Sauberes Wasser</span>
                <span className="text-xs text-gray-500">z.B. Leitungswasser, Regenwasser</span>
              </Label>
            </div>
          </div>
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="kontaminiert" id="wasser-kontaminiert" className="text-accent border-gray-300 focus:ring-accent" />
            <div className="flex-1">
              <Label htmlFor="wasser-kontaminiert" className="flex flex-col cursor-pointer">
                <span className="font-medium">Kontaminiertes Wasser</span>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                !schadensDatum && "text-muted-foreground"
              )}
            >
    ...
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        <RadioGroup
          ...
          onValueChange={handleSchimmelSichtbar}
          className="space-y-3"
        >
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="ja" id="schimmel-sichtbar-ja" className="text-accent border-gray-300 focus:ring-accent" />
            <div className="flex-1">
              <Label htmlFor="schimmel-sichtbar-ja" className="flex flex-col cursor-pointer">
                <span className="font-medium">Ja, der Schimmel ist sichtbar</span>
              </Label>
            </div>
          </div>
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="nein" id="schimmel-sichtbar-nein" className="text-accent border-gray-300 focus:ring-accent" />
            <div className="flex-1">
              <Label htmlFor="schimmel-sichtbar-nein" className="flex flex-col cursor-pointer">
                <span className="font-medium">Nein, aber es gibt Anzeichen</span>
      ...
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="flex max-w-xs">
          ...
          <span className="ml-2 self-center text-gray-600">m²</span>
        </div>
      </div>
      ...
      <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
        ...
        <RadioGroup
          ...
          onValueChange={handleSchimmelUrsacheBekannt}
          className="space-y-3"
        >
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="ja" id="ursache-bekannt-ja" className="text-accent border-gray-300 focus:ring-accent" />
            <Label htmlFor="ursache-bekannt-ja" className="cursor-pointer font-medium">Ja</Label>
          </div>
          <div className="flex items-center space-x-2 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
            <RadioGroupItem value="nein" id="ursache-bekannt-nein" className="text-accent border-gray-300 focus:ring-accent" />
            <Label htmlFor="ursache-bekannt-nein" className="cursor-pointer font-medium">Nein</Label>
          </div>
        </RadioGroup>
  ...
  const renderSonstigeDetails = () => (
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 text-blue-800">
        <div className="flex items-center mb-2">
          <Info className="h-5 w-5 mr-2" />
          <h3 className="font-medium">Individuelle Sanierung</h3>
        </div>
        <p>
  ...
  return (
    ...
    >
      ...
      {error && (
        <motion.div 
          className="mt-6 p-3 bg-red-50 border border-red-200 rounded-md text-red-600 text-sm text-center max-w-2xl mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
      ...
      <div className="flex justify-between max-w-2xl mx-auto">
        ...
        <motion.button
          ...
          whileHover={(isValid || formData.schadensart.hauptkategorie === 'sonstiges') ? { scale: 1.03 } : {}}
          whileTap={(isValid || formData.schadensart.hauptkategorie === 'sonstiges') ? { scale: 0.97 } : {}}
        >
          Weiter
        </motion.button>
      </div>
