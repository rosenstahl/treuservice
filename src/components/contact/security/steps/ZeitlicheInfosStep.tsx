...
export const ZeitlicheInfosStep: React.FC<ZeitlicheInfosStepProps> = ({ 
  ...
  // Funktion zum Aktualisieren des formData (nach Bedarf aufrufen)
  ...
  // Handler für einfache Text-Inputs
    ...
    >
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {Object.entries(dauerTypes).map(([type, info]) => (
                ...
                >
                  <div className={`flex items-center ${localState.dauerTyp === type ? 'text-accent' : 'text-gray-700'}`}>
          ...
          {/* Zeitraum auswählen mit dem Kalender-Komponente */}
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-sm font-medium text-gray-700 mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <Label htmlFor="beginnDatum" className="block text-sm font-medium text-gray-700 mb-2">
                  Startdatum *
                </Label>
                <Popover>
...
>                      <CalendarIcon className="mr-2 h-4 w-4" />
              ...
              {localState.dauerTyp !== 'einmalig' && localState.dauerTyp !== 'unbefristet' && (
                <div>
                  <Label htmlFor="endeDatum" className="block text-sm font-medium text-gray-700 mb-2">
                    Enddatum *
                  </Label>
                  <Popover>
                    <PopoverTrigger asChild>
...
>                        <CalendarIcon className="mr-2 h-4 w-4" />
              ...
              <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all">
                ...
                <div>
                  <Label htmlFor="feiertagsdienst" className="flex items-center text-sm font-medium text-gray-700">
                    <CalendarIcon className="h-4 w-4 mr-1 text-red-600" /> Feiertagsdienst
                  </Label>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-2">
                  <Label htmlFor="adresseStrasse" className="block text-sm font-medium text-gray-700 mb-2">
                    Straße *
                  </Label>
                  <Input
                    id="adresseStrasse"
                ...
                <div>
                  <Label htmlFor="adresseHausnummer" className="block text-sm font-medium text-gray-700 mb-2">
                    Hausnummer *
                  </Label>
                  <Input
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <Label htmlFor="adressePlz" className="block text-sm font-medium text-gray-700 mb-2">
                    PLZ *
                  </Label>
                  <Input
                    id="adressePlz"
                ...
                <div className="col-span-2">
                  <Label htmlFor="adresseOrt" className="block text-sm font-medium text-gray-700 mb-2">
                    Ort *
                  </Label>
                  <Input
                    id="adresseOrt"
          ...
          {/* Anmerkungen */}
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
            <Label htmlFor="anmerkungen" className="block text-sm font-medium text-gray-700 mb-2">
