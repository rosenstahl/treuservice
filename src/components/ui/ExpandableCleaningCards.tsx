            ...
            >
              ...
              <div className="flex flex-col flex-1 overflow-auto">
                ...
                <div className="mt-auto p-6 bg-primary">
                  <button className="w-full bg-accent hover:bg-accent-hover text-primary-light py-3 px-6 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors">
