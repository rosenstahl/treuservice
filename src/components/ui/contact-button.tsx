...
const ContactButton: React.FC<ContactButtonProps> = ({ text }) => {
  return (
    <button className="w-full bg-accent hover:bg-accent-hover text-xl text-white px-4 py-3 pl-[0.9em] flex items-center justify-center border-none rounded-2xl overflow-hidden transition-all duration-200 cursor-pointer hover:scale-95 active:scale-95 group relative h-[60px]">
      {/* Text Container */}
