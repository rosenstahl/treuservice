...
/**
 * Vereinfachte Komponente zum Anzeigen von Wetter-Icons
 * 
 * Verwendet die icon-Namen direkt aus der BrightSky API ohne Umwandlung:
 * - clear-day, clear-night
 * - partly-cloudy-day, partly-cloudy-night
 * - cloudy, fog, rain, sleet, snow
 * - thunderstorm, drizzle, hail, wind, dry
 */
