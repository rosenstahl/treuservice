...
const validPaths = [
  ...
  'temporary-staffing',
  'blog',
  'blog/MaterialspezifischeReinigung',
  'blog/FleckenentfernungsBerater',
  'blog/NachhaltigeReinigung',
  'blog/StreumittelRechnerundVergleich',
  ...
  'blog/EntruempelungsGuide',
  'blog/SanierungsGuide',
  'blog/LeiharbeitGuide'
]
